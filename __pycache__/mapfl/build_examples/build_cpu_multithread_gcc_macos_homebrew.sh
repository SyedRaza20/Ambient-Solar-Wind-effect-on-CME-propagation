...
HDF5_INCLUDE_DIR="/opt/homebrew/Cellar/hdf5-mpi/1.14.3/include/"
HDF5_LIB_DIR="/opt/homebrew/Cellar/hdf5-mpi/1.14.3/lib/"
# Fortran HDF5 library flags (these can be version dependent):
HDF5_LIB_FLAGS="-lhdf5_fortran -lhdf5_hl_fortran -lhdf5 -lhdf5_hl -ld_classic"
